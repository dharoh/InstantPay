...
public class upi4digit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.upi_4digit);
...
TextView tv=(TextView)findViewById(R.id.Bname);
    ...
    {
        Intent i=new Intent(upi4digit.this,set_upi.class);
        bundle.remove("upi_sts");
        bundle.putInt("upisize",4);
        i.putExtras(bundle);
        startActivity(i);
    }
    ...
    public void Next(View v)
    {
        ...
        String upi=p[0].getText().toString()+p[1].getText().toString()+p[2].getText().toString()+p[3].getText().toString();
        ResultSet res;
        try {
            ...
            if (upists.equals("yes")) {
                ...
                if (res.next()) {
                    ...
                    ResultSet rst= stmt.executeQuery("select * from [bank_data] where account_no='"+account+"'");

                    if(rst.next()) {
                        stmt.executeUpdate("update [User] set bank_id='" + rst.getString(3) + "',debit_card_no='"+rst.getString(2)+"',account_no='"+rst.getString(1)+"',name='"+rst.getString(7)+"' where mobile_no='"+mobile+"'");
                    ...
                    Intent i=new Intent(upi4digit.this,MainActivity.class);
            ...
            else if(upists.equals("check"))
            {
                ...
                if(rs.next())
                {
                      ...
                      time=sd.format(dt);
                        ...
                        int z=smt.executeUpdate();
                            if(z>0) {
                                    ...
                                    Intent i = new Intent(upi4digit.this, sucesstransaction.class);
                                    Bundle b=new Bundle();
                                    b.putString("tid",tid);
                    ...
                    {
                        AlertDialog.Builder builder = new AlertDialog.Builder(upi4digit.this);
            ...
            else if(upists.equals("bal"))
            {
                    ...
                    builder.setMessage("You have current balance is account is "+rest.getString(1).substring(0,rest.getString(1).length()-2)).setCancelable(false).setNeutralButton("OK",
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent i=new Intent(upi4digit.this,bankaccount.class);
                                    Bundle b=new Bundle();
                                    b.putString("mobile",mobile);
                                    i.putExtras(b);
                                    finishAffinity();
                ...
                if (attempt == 1) {
                    upis = p[0].getText().toString() + p[1].getText().toString() + p[2].getText().toString() + p[3].getText().toString();
                    for (int i = 0; i < 4; i++)
                        p[i].setText("");
                    attempt = 2;
                    ...
                    if (upis.equals(p[0].getText().toString() + p[1].getText().toString() + p[2].getText().toString() + p[3].getText().toString())) {
                        {
                            ...
                            Date dt=new Date();
                            String time=sd.format(dt);
                            s.execute("insert into [Login_detail](mobile_no,tdate,login_type,account_no)values('"+mobile+"','"+time+"','N','"+account+"')");
